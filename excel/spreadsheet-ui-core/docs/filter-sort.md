...
`excel/solid-excel/docs/online-excel-parity/design-filter-hidden-rows.md` for the
...
(`excel/solid-excel/docs/online-excel-parity/design-engine-hidden-rows.md`, slices E2–E8,
...
- Host side: `excel/solid-excel/test/vnext-reapply-filter.test.ts` (Reapply against the
  real static backend, both counter-example directions),
  `vnext-reapply-filter-keyboard.test.tsx` (`Ctrl+Alt+L` grid wiring),
  `excel/solid-excel/test/vnext-filter-hidden-rows.test.ts`,
