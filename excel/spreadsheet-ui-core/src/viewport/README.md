...
`excel/solid-excel/docs/online-excel-parity/CANONICAL_OWNERSHIP.md`. The backend
...
(`excel/solid-excel/docs/online-excel-parity/design-engine-hidden-rows.md`, slices E2/E7,
