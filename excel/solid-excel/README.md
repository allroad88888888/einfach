...
Interaction, clipboard, worker, or viewport changes must also clear an MCP Playwright pass; the kanban in `excel/spreadsheet-ui-core/docs/AGENT_COLLABORATION.md` documents the required notes (URL, operation path, visible cell count, console warnings, parity conclusion).
