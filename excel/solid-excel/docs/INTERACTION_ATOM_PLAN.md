...
>
> 说明：本文暂放在 `excel/solid-excel/docs/`，因为新包尚未创建。PC-1 创建
> `excel/spreadsheet-ui-core/` 后，应把核心架构文档迁到新包 `README.md` 或 `docs/`。
...
- `excel/solid-excel/src/sheet-store.ts`：selection、anchor、订阅 tick。
- `excel/solid-excel/src/Table.tsx`：滚动视口、右键菜单。
- `excel/solid-excel/src/FormulaBar.tsx`：draft、focused、formulaError。
- `excel/solid-excel/src/ContextMenu.tsx`：highlight、菜单位置。
- `excel/solid-excel/src/SheetTabs.tsx`：sheet tab context menu。
...
- 不在 `excel/solid-excel/src` 里继续扩张新的核心交互状态架构。
...
第一版按在线 Excel 的功能拆到新包 `excel/spreadsheet-ui-core/src/` 下：
...
| PC-1 | 新包骨架 | Package / Feature folders / Test harness | `excel/spreadsheet-ui-core`、功能文件夹、README 决策模板 |
...
| PC-6 | Solid Excel vNext | Solid UI / Backend adapter / Demos | `excel/solid-excel/src-vnext` 平行实现，旧 UI 不动 |
| PC-7 | 切入口与收口 | Package entry / E2E / MCP | `@einfach/solid-excel` 入口切到 vNext，legacy 冻结或删除计划 |

### 当前执行记录

2026-05-14 第一批已落地到 `excel/spreadsheet-ui-core`：
...
- PC-6 第一段：`excel/solid-excel/src-vnext` 已接入 Provider、静态 backend adapter、可视窗口
  Grid、vNext demo tab 和 smoke e2e；legacy `excel/solid-excel/src` 未被迁移或删除。
...
- PC-6 第十九段：vNext ContextMenu 已接大范围 TSV streaming clipboard export。
  ...
  cell。
- PC-7 准备第一段：vNext paste 公式引用偏移逻辑已从 legacy `excel/solid-excel/src`
...
- PC-7 准备第二段：`@einfach/solid-excel` legacy package entry 已显式暴露
  ...
  surface 单独收敛到 `excel/solid-excel/src-vnext/public.ts`，不导出 demo，避免 package entry
...
- PC-7 准备第六段：worker workbook proxy/protocol 已从 legacy
  `excel/solid-excel/src/wasm-workbook-proxy.ts` 迁到 vNext adapter 的
  `excel/solid-excel/src-vnext/adapter/worker-protocol.ts`。legacy 文件现在只 re-export
...
- PC-7 准备第七段：真实 worker runtime 已迁到
  `excel/solid-excel/src-vnext/adapter/worker-runtime.ts`，vNext worker factory 改为指向
  `./worker-runtime.ts`；legacy `excel/solid-excel/src/wasm-workbook-worker.ts` 只做兼容 shim，
...
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-provider.test.tsx excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npx jest excel/spreadsheet-ui-core/test --runInBand`
...
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-provider.test.tsx excel/solid-excel/test/vnext-grid.test.tsx excel/solid-excel/test/vnext-formula-bar.test.tsx excel/solid-excel/test/vnext-sheet-tabs.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts`
...
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test --runInBand`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-provider.test.tsx excel/solid-excel/test/vnext-grid.test.tsx excel/solid-excel/test/vnext-formula-bar.test.tsx excel/solid-excel/test/vnext-sheet-tabs.test.tsx excel/solid-excel/test/vnext-toolbar.test.tsx excel/solid-excel/test/vnext-context-menu.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts`
...
- `npx jest excel/solid-excel/test/vnext-status-bar.test.tsx excel/solid-excel/test/vnext-context-menu.test.tsx --runInBand`
- `npx jest excel/solid-excel/test/vnext-*.test* --runInBand`
- `npx jest excel/spreadsheet-ui-core/test --runInBand`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npm run build -w @einfach/solid-excel`
...
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/i18n.test.ts --runInBand`
- `npx jest excel/solid-excel/test/vnext-*.test* --runInBand`
- `npm run build -w @einfach/solid-excel`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-context-menu.test.tsx excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npx jest excel/spreadsheet-ui-core/test --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-context-menu.test.tsx excel/solid-excel/test/wasm-workbook-proxy.test.ts excel/solid-excel/test/wasm-workbook-worker.test.ts excel/solid-excel/test/worker-workbook-store.test.ts --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-grid.test.tsx excel/solid-excel/test/vnext-toolbar.test.tsx --runInBand`
- `npx jest excel/solid-excel/test/vnext-*.test* --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/clipboard.test.ts excel/solid-excel/test/vnext-context-menu.test.tsx --runInBand`
- `npx jest excel/solid-excel/test/vnext-context-menu.test.tsx excel/solid-excel/test/vnext-grid.test.tsx excel/spreadsheet-ui-core/test/clipboard.test.ts --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/sheet-tabs.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-sheet-tabs.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `npm run build`
- `npm test`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/viewport.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/keyboard.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/keyboard.test.ts excel/spreadsheet-ui-core/test/sheet-tabs.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/pointer.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/solid-excel/test/vnext-adapter.test.ts --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/sheet-tabs.test.ts excel/solid-excel/test/vnext-sheet-tabs.test.tsx excel/solid-excel/test/vnext-adapter.test.ts --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/backend-contract.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-grid.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npm run build -w @einfach/spreadsheet-ui-core`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npx jest excel/spreadsheet-ui-core/test/backend-contract.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/vnext-context-menu.test.tsx --runInBand`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
- `npm run build`
...
- `npx jest excel/solid-excel/test/package-entry.test.ts excel/solid-excel/test/vnext-provider.test.tsx --runInBand`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts`
- `git diff --check`
...
- `npx jest excel/solid-excel/test/package-vnext-subpath.test.ts excel/solid-excel/test/package-entry.test.ts --runInBand`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-smoke.spec.ts`
- `git diff --check`
...
- `rg -n "\\.\\./\\.\\./src|\\.\\./src|from '../../src|from '../src" excel/solid-excel/src-vnext -g '*.ts' -g '*.tsx'`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/solid-excel`
...
- `rg -n "\\.\\./\\.\\./src|\\.\\./src|from '../../src|from '../src" excel/solid-excel/src-vnext -g '*.ts' -g '*.tsx'`
- `npx jest excel/solid-excel/test/package-vnext-subpath.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/wasm-workbook-proxy.test.ts --runInBand`
- `npx jest excel/solid-excel/test/wasm-workbook-worker.test.ts excel/solid-excel/test/worker-workbook-store.test.ts --runInBand`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
...
- `rg -n "\\.\\./\\.\\./src|\\.\\./src|from '../../src|from '../src" excel/solid-excel/src-vnext -g '*.ts' -g '*.tsx'`
- `npx jest excel/solid-excel/test/package-vnext-subpath.test.ts excel/solid-excel/test/vnext-adapter.test.ts excel/solid-excel/test/wasm-workbook-proxy.test.ts excel/solid-excel/test/wasm-workbook-worker.test.ts excel/solid-excel/test/worker-workbook-store.test.ts --runInBand`
- `npx tsc -p excel/solid-excel/tsconfig.json --noEmit --pretty false`
- `npm run build -w @einfach/solid-excel`
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-worker-backend.spec.ts`
- `git diff --check`
...
- `NO_PROXY=localhost,127.0.0.1 npm run e2e -w @einfach/solid-excel -- e2e/vnext-worker-backend.spec.ts`
- `rg -n "with_cross_resolver|CrossSheetResolver|mem::transmute|CROSS_RESOLVER|CURRENT_SHEET|CROSS_SHEET_VISITED" excel/rust/excel-core/src excel/rust/wasm/src excel/rust/excel-core/tests excel/rust/wasm/tests`
- `rg -n "test\\.skip|describe\\.skip|it\\.skip|test\\.only|describe\\.only|it\\.only" excel/solid-excel/e2e excel/solid-excel/test`
- `git diff --check`
...
- PC-7 后续多批次 agent 执行计划已单独落到
  `excel/solid-excel/docs/PC7_AGENT_PIPELINE.md`。W1-W2 已完成；接下来按该文档的 W3-W7 波次推进，
  每波由总架构师收口并要求测试 + MCP Playwright 验证。

## 并行 Agent 计划

总架构师负责接口冻结、集成和最终验收。子 agent 只能提交候选补丁。
PC-7 后续执行以 `excel/solid-excel/docs/PC7_AGENT_PIPELINE.md` 为准；本节保留为
...
| 角色 | 推荐模型 | 文件所有权 | 任务 |
|---|---|---|---|
| A1 Package Skeleton | Codex Spark | `excel/spreadsheet-ui-core/package.json`, `tsconfig.json`, `src/index.ts` | 新建 workspace package，只依赖 `@einfach/core` |
| A2 Feature Folders | Codex Spark | `excel/spreadsheet-ui-core/src/*/README.md`, `shared/*` | 建功能文件夹、公共类型边界、atom 决策模板 |
| A3 Backend Port | Claude Sonnet | `excel/spreadsheet-ui-core/src/backend/*` | 定义 visible read、mutation、range command 的端口类型 |
| A4 Tests | Codex Mini | `excel/spreadsheet-ui-core/test/*` | 新包测试 harness、folder contract、visible window 单测 |

验收：

```sh
npx tsc -p excel/spreadsheet-ui-core/tsconfig.json --noEmit
npx jest excel/spreadsheet-ui-core/test
npm run build -w @einfach/spreadsheet-ui-core
```
...
```sh
npx tsc -p excel/spreadsheet-ui-core/tsconfig.json --noEmit
npx jest excel/spreadsheet-ui-core/test/viewport*.test.ts excel/spreadsheet-ui-core/test/projection*.test.ts
```
...
上继续修补，而是在 `excel/solid-excel/src-vnext/` 平行实现新的 Solid UI。它面向用户感知，必须用
MCP 验证。
...
| 角色 | 推荐模型 | 文件所有权 | 任务 |
|---|---|---|---|
| F1 Solid Provider | Codex Spark | `excel/solid-excel/src-vnext/provider/*` | 连接 `@einfach/spreadsheet-ui-core` store 和 `@einfach/solid` |
| F2 Backend Adapter | Claude Sonnet | `excel/solid-excel/src-vnext/adapter/*` | 把现有 worker/Rust store 适配到 core backend port |
| F3 Grid UI | Codex Spark | `excel/solid-excel/src-vnext/grid/*` | 可视窗口 grid、headers、cells、overlay，不保存 workbook facts |
...
| F5 Demo/E2E | Codex Spark | `excel/solid-excel/src-vnext/demos/*`, `excel/solid-excel/e2e/*` | vNext demo flag、Playwright 和 MCP 验证 |

目标：

- 保留 `@einfach/solid-excel` 包名。
- 旧 `excel/solid-excel/src` 先不删，作为 legacy/reference。
- 新实现放在 `excel/solid-excel/src-vnext`，通过 demo flag 或独立 route 验证。
