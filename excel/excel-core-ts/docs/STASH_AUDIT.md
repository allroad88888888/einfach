...
- Files: `excel/solid-excel/package.json` (1 file, +4/-1)
- Verdict: **DROP**
...
- Files: `excel/solid-excel/src-vnext/grid/SpreadsheetGrid.tsx` (1 file, +25/-0)
- Verdict: **DROP**
...
- Files: `excel/solid-excel/src-vnext/grid/SpreadsheetGrid.tsx`, `grid/index.ts` (2 files, +80/-0)
- Verdict: **DROP**
...
- Files: `SpreadsheetGrid.tsx`, `grid/index.ts`, `excel/spreadsheet-ui-core/src/index.ts` (3 files, +81/-0)
- Verdict: **DROP**
...
- Verdict: **DROP**
- Reasoning: Pre-commit checkpoint for the NameBox feature. All target files exist on disk: `excel/solid-excel/src-vnext/name-box/SpreadsheetNameBox.tsx`, `excel/spreadsheet-ui-core/src/name-box/{index,types}.ts`, the formula-bar's `SpreadsheetNameBox` mount, and the UI-core re-export (`export * from './name-box'`). The feature shipped.

### stash@{14} — "wave5-sibling-stash-2"
- Files: `excel/spreadsheet-ui-core/src/index.ts` (1 file, +2/-0)
- Verdict: **DROP**
- Reasoning: Adds the `export * from './name-box'` and `export * from './menu-bar'` lines. Both re-exports are present on disk at lines 18 and 26 of `excel/spreadsheet-ui-core/src/index.ts`. Trivially superseded.
