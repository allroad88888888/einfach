 ...
 * Rust engine (see excel/rust/excel-core/docs/AUDIT_PATTERN_FAMILY_2026-06-12.md,
 ...
 *         additionally drains core/core's pending-read bookkeeping
...
describe('AUDIT C-2 (FIXED): mutations dirty O(dependents), not O(cached formulas)', () => {
  test.each([1_000, 10_000, 100_000])(
    ...
    (formulaCount) => {
      ...
      // The first setter after a host-read burst drains core/core's
