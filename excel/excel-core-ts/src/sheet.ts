...
export interface SheetResolvers {
   ...
   * registers a core/core dep (cross-sheet invalidation flows through
...
export function createSheet(
  ...
  // Debug-probe side tables. None participate in core/core dependency
  ...
  function formulaCellAtom(key: CellKey): AtomEntity<Value> {
    ...
    const a = atom((get) => {
      ...
      // is a core/core cache miss by definition (the derive only runs
