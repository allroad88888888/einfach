...
*Scope: Phase 5 of `excel/rust/excel-core/docs/LAZY_FORMULA_INDEXING_PLAN.md`.*
...
- Built wasm-pkg via `npm --prefix excel/solid-excel run build:wasm`.
- Added `excel/solid-excel/test/perf-rust-bulk-import-ultra.bench.ts`. Each tier:
...
- The bench file `excel/solid-excel/test/perf-rust-bulk-import-ultra.bench.ts`
