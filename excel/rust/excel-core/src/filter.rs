...
//! `excel/spreadsheet-ui-core/src/backend/projection-helpers.ts`, and the
...
/// `ColumnFilterRule` (`excel/spreadsheet-ui-core/src/filter-sort/types.ts:12-16`).
///
...
/// convention `sortRange` established (`excel/rust/wasm/src/lib.rs`
