...
//! point.
//!
//! See `excel/spreadsheet-ui-core/docs/ROADMAP.md` for the Phase 3
//! scope, `excel/rust/core/src/atom.rs` § `ArrayData` for the value variant,
//! and `excel/rust/excel-core/src/sheet.rs` § "Spill (dynamic-array)
...
fn workbook_sequence_round_trip() {
    ...
    // WASM-boundary collapse lives in `excel/rust/wasm`, not in
