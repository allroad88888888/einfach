...
- `wasm-pack test --headless --chrome excel/rust/wasm` 覆盖浏览器 callback 和 lazy workbook。
...
- Release gate 已落地：本地 Rust/WASM/Jest/Solid/Playwright + MCP 验收完成并记录到
  `excel/rust/docs/RELEASE_GATE_PLAN.md`。当前阶段是发布决策 checkpoint。
...
- `excel/rust/excel-core/src/sheet.rs`
- `excel/rust/excel-core/src/eval.rs`
...
- `excel/rust/wasm/tests/web.rs`
- `excel/solid-excel/src/wasm-sheet-proxy.ts`
- `excel/solid-excel/src/wasm-sheet-worker.ts`
...
- `excel/solid-excel/src/Table.tsx`
- `excel/solid-excel/src/Cell.tsx`
- `excel/solid-excel/src/FormulaBar.tsx`
- `excel/solid-excel/src/sheet-store.ts`
- 相关 e2e specs。
...
- `excel/rust/excel-core/tests`
- `excel/rust/wasm/tests`
...
- `excel/rust/docs/ROADMAP.md`
- `excel/rust/docs/ISSUES.md`
- `excel/rust/docs/LAZY_FORMULA_EVAL.md`
- `excel/solid-excel/docs/E2E_TEST_PLAN.md`
- 本文档。
...
细节以 `excel/rust/docs/ONLINE_SPREADSHEET_EXECUTION_WAVES.md` 为准。
