...
Built by `wasm-pack` and consumed by `excel/solid-excel/` via a relative
package reference at `excel/rust/wasm/wasm-pkg`.
...
- See `excel/rust/docs/TODO.md` 2.3 for the wasm-bindgen-test bring-up history
