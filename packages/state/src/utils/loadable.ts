 ...
 * @returns 
 */
export function loadable<State, Entity extends Atom<State>>(anAtom: Entity):
    ...
    return memo(function () {
        ...
        var loadableCache = new WeakMap<StatesWithPromise<AtomState<Entity>>,
            Res<AtomState<Entity>>>();

        var refreshAtom = atom(0);

        const derivedAtom = atom<Res<AtomState<Entity>>, [], void>(function (getter, { setter }) {
