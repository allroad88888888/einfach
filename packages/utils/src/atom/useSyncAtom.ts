...
export function syncAtom<T extends Atom<unknown>>(atomEntity: T,
    store: Store, syncStore: Store) {
...
export function useSyncAtom<T extends Atom<unknown>>(atomEntity: T,
    store: Store, syncStore: Store) {
