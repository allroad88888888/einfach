...
//!
//! See `rust/core/src/atom.rs` § `ArrayData` and
//! `rust/excel-core/src/sheet.rs` § "Spill (dynamic-array) infrastructure"
...
//
// The WASM boundary (`rust/wasm/src/lib.rs` § `collapse_array_for_js`)
