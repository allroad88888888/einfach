 ...
 *
 * Mirrors the shape of `rust/excel-core/src/workbook.rs::Workbook`
 ...
 * (deliberate — see `rust/docs/TODO.md` 1.5).
 *
 ...
 * lands when (a) `WasmWorkbook` is exposed from `rust/wasm/src/lib.rs`
