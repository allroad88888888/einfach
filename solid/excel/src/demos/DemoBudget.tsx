...
export function DemoBudget() {
  const store = createWorkbookStore(createJSWorkbook({ sheets: [{ name: 'Sheet1', rows: 17, cols: 8 }] }))
  ...
  return (
    <div class="demo-page">
      <div class="demo-header">
        ...
        <p class="demo-desc">
          Edit the budget and actual columns, then try inserting rows or freezing the top band.
