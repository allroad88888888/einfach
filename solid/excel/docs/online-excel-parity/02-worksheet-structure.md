...
| 层                            | 负责内容                                                                                                                                                                                                                                       | 明确禁止                                                                                                         |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `vanilla/spreadsheet-ui-core` | 纯数据的 command/intents、选择归一化、区间/run 运算、capability 派生、交互/执行状态 atoms、结构结果到 viewport/sheet-tabs 的投影；提供 static/worker 共用测试夹具。                                                                            | DOM 测量、Solid API、后端私有分支、每行/每列/每单元格无界 atom。                                                 |
