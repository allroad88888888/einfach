...
| released | `/root/docs_evidence_refresh`                      | `solid/excel/docs/online-excel-parity/**`                                   | `Docs Evidence MAIN_REVIEW_ACCEPTED / released`；facts / links / Mermaid / Prettier gates                                                                              | 不改源码、不预宣称另两路成功                                                                                                                               |
...
3. F-1 的 H0 材料就绪：基线 `2feea48`；owner CC-A/A05；具名 worker：CC-A 会话本体；限定路径 `vanilla/excel-core-ts/src/rewrite/**`、`src/condition/**`、`test/fixtures/formula-core-golden.v1.json`、`test/golden-formula-core.test.ts`、`src/index.ts`（仅导出行）；不碰汇聚文件；上游合同：无（F-1 自身是 2/3/4 组上游）；窗口 07-14~07-17。
...
| --------------------------------------------------------- | ---: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| W0-DIALOG / CC-B 具名非-root worker；限定恢复后返工       |   17 | `solid/excel/src-vnext/conditional-formatting/SpreadsheetConditionalFormatDialog.tsx`<br>`solid/excel/src-vnext/data-validation/SpreadsheetDataValidationDialog.tsx`<br>`solid/excel/src-vnext/find-replace/SpreadsheetFindReplaceDialog.tsx`<br>`solid/excel/src-vnext/name-box/SpreadsheetNameBox.tsx`<br>`solid/excel/src-vnext/protection/SpreadsheetProtectionUnlockDialog.tsx`<br>`vanilla/spreadsheet-ui-core/src/conditional-formatting/index.ts`<br>`vanilla/spreadsheet-ui-core/src/conditional-formatting/types.ts`<br>`vanilla/spreadsheet-ui-core/src/data-validation/index.ts`<br>`vanilla/spreadsheet-ui-core/src/data-validation/types.ts`<br>`vanilla/spreadsheet-ui-core/src/find-replace/index.ts`<br>`vanilla/spreadsheet-ui-core/src/find-replace/types.ts`<br>`vanilla/spreadsheet-ui-core/src/name-box/index.ts`<br>`vanilla/spreadsheet-ui-core/src/protection/index.ts`<br>`vanilla/spreadsheet-ui-core/test/conditional-formatting.test.ts`<br>`vanilla/spreadsheet-ui-core/test/data-validation.test.ts`<br>`vanilla/spreadsheet-ui-core/test/find-replace.test.ts`<br>`vanilla/spreadsheet-ui-core/test/protection.test.ts` |
| i18n preservation-only；等待用户另行授权具名非-root owner |    2 | `solid/excel/src/LocaleSwitcher.tsx`<br>`solid/excel/src/i18n/index.ts`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| DOCS / `/root` 文档主审与限定集成                         |   16 | `solid/excel/README.md`<br>`solid/excel/docs/online-excel-parity/02-worksheet-structure.md`<br>`solid/excel/docs/online-excel-parity/03-editing.md`<br>`solid/excel/docs/online-excel-parity/04-cell-formatting.md`<br>`solid/excel/docs/online-excel-parity/05-formulas.md`<br>`solid/excel/docs/online-excel-parity/06-tables-data-management.md`<br>`solid/excel/docs/online-excel-parity/13-changes-views-versions.md`<br>`solid/excel/docs/online-excel-parity/CUTOVER_INVENTORY.md`<br>`solid/excel/docs/online-excel-parity/INFLIGHT.md`<br>`solid/excel/docs/online-excel-parity/MULTI_AGENT_EXECUTION.md`<br>`solid/excel/docs/online-excel-parity/README.md`<br>`solid/excel/docs/online-excel-parity/REVIEW-2026-07-14.md`<br>`solid/excel/docs/online-excel-parity/WORK_SPLIT_PROPOSAL-2026-07-14.md`<br>`solid/excel/docs/online-excel-parity/comments-notes-tasks.md`<br>`solid/excel/docs/online-excel-parity/reviews/2026-07-14-CC-A-w0-dialog-migration.md`<br>`solid/excel/docs/online-excel-parity/reviews/README.md`                                                                                                                |
