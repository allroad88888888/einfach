...
Modal lives at
`solid/excel/src-vnext/format-cells/SpreadsheetFormatCellsDialog.tsx`. It is
...
`solid/excel/src-vnext/grid/` is responsible for:
...
- `solid/excel/src-vnext/format-cells/SpreadsheetFormatCellsDialog.tsx` —
  new. `solid/excel/src-vnext/grid/` — rotation / overflow / wrap.
  `solid/excel/src-vnext/toolbar/SpreadsheetToolbar.tsx` — "More formats"
  entry.
