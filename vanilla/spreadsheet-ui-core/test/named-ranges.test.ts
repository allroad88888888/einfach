...
describe('NR-C0 static controller boundaries', () => {
  const sourceFiles = [
    'vanilla/spreadsheet-ui-core/src/named-ranges/index.ts',
    'vanilla/spreadsheet-ui-core/src/named-ranges/types.ts',
    'vanilla/spreadsheet-ui-core/src/name-box/index.ts',
    'vanilla/spreadsheet-ui-core/src/name-box/types.ts',
  ]
  ...
  test('C15 keeps transport writers synchronous and returns no transport Promise', () => {
    const namedRangesSource = readFileSync(
      join(process.cwd(), 'vanilla/spreadsheet-ui-core/src/named-ranges/index.ts'),
      'utf8',
    )
    const nameBoxSource = readFileSync(
      join(process.cwd(), 'vanilla/spreadsheet-ui-core/src/name-box/index.ts'),
      'utf8',
    )
    const writers = [
